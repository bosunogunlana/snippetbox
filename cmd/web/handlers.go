...
import (
	...
	"snippetbox.paqet.io/internal/models"
	"snippetbox.paqet.io/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedValue(form.Expires, 1, 7, 365), "expires", "This field must be either of 1, 7, 365")
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "Email must be valid")
	...
	if err != nil {
		if errors.Is(err, models.ErrDuplicateEmail) {
			form.AddFieldError("email", "Email is taken")
